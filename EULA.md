# End-User License Agreement (EULA) for mcp-link-server
...
"**Software**" means the mcp-link server components, associated tools, plugins, and any related services or applications that communicate with the server. Aura Friday grants you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to install and use the Software for personal or internal business use, in accordance with this EULA.

### 2. IMPORTANT: Acknowledgement of Inherent Risks of Agentic AI, and your Duties

**mcp-link-server is a powerful tool that enables artificial intelligence agents to execute commands, access files, and perform real-world actions on your local machine. The use of such technology carries inherent and significant risks.**
...
## 3. Server Tools, Plugins, and Third-Party Content

The Software may include or connect to tools, plugins, models, or content from third parties.
Aura Friday may review third-party content but this is best-efforts only and **NOT A GUARANTEE OF SAFETY, SECURITY, OR FITNESS**. You alone decide what tools to enable, what plugins to install, and what third-party services to trust. You use all third-party content at your own risk.
...
<small><sup>Copyright © 2025 Christopher Drake. All rights reserved. "signature": "ЕѵAɗ𐓒ɯsƧLԝ𝖠2UĸȢМƱуᴜ0ⲘmⴹМոJƵЅ𝐴HƤꓪPƏƧОŧбΜxƤHΟνꓳ𝟩Τ5īց3Ɵᴅб৭𝟫ᏮRƊʈ𝟧ΡЅ4ⅼ𝟙ᎠⅮᎠɋīȣFꓳН7𝟑еƌΤꓑ𝕌ѵꓰƌꓦKL𝟨ƳRɯꓬց×ꓚҳΥοꓧӠjⅼΤΥn×ցο". "signdate":"2025-09-03T14:39:43.224Z" </sup></small>
-
